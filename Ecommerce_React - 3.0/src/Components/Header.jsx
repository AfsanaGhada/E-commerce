            ...
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                  <li><a href="home" class="dropdown-item">About Us </a></li>
                  <li><a href="Category" class="dropdown-item">Category </a></li>
                  <li><a href="Products" class="dropdown-item">Shop </a></li>
                  <li><a href="discount" class="dropdown-item">Discount </a></li>
                  <li><a href="featured-products" class="dropdown-item">Featuredproducts </a></li>
                  <li><a href="signUp" class="dropdown-item">SignUpResister </a></li>
                  <li><a href="popular-Products" class="dropdown-item">PopularProducts </a></li>
                  <li><a href="arrived" class="dropdown-item">Arrived </a></li>
                  <li><a href="blog" class="dropdown-item">Blog </a></li>
                  <li><a href="download-app" class="dropdown-item">DownloadApp </a></li>
                  <li><a href="visited" class="dropdown-item">Visited</a></li>
                  <li><a href="features" class="dropdown-item">features </a></li>
