...
import Cart from './Components/User/Cart'; // This line should match the file path
import Footer from './Components/Footer';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/user" element={user ? <UserDashboard /> : <Login setUser={setUser} />} />
        <Route path="/cart" element={user ? <Cart /> : <Login setUser={setUser} />} />
      </Routes>
      <Footer />
    </Router>
  );
